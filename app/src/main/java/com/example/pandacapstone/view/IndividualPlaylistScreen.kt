...
fun IndividualPlaylist(
    ...
    var continueDeliveries by remember { mutableStateOf(true) }
    ...
    LazyColumn() {
        item {
            ...
            Row(
                ...
                Switch(
                    checked = continueDeliveries,
                    onCheckedChange = { switchState -> continueDeliveries = switchState },
                                    ...
                                    Column {
                                        Row(
                                            ...
                                            Row(verticalAlignment = Alignment.CenterVertically) {
                                                ...
                                                Text(text = " ("+ item.numberOfReviews.toString() + ")", style = TextStyle(fontSize = 13.sp))
                                            }
                                        }
                                        Row(
